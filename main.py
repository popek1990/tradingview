...
# Ustawiamy plik, ktory nie istnieje, aby biblioteka nie probowala go otwierac.
limiter = Limiter(key_func=get_remote_address, default_limits=["30/minute"], config_filename=".env.no_load")
