...
Subdomena : tv.popeklab.com > Service : http://localhost:80
Subdomena tvpanel.popeklab.com > Service http://localhost:8501

# Cloudflare - moja konfiguracja
Moja główna domena : popeklab.com
Page Shield : włączone
Bot Fight mode : wyłączone (blokuje TradingView)
Leaked credentials mitigation : Activated
Ochrona DDOS/SSL/TLS : włączona
...
- Nie wysyłaj plików @claude.md oraz @gemini.md oraz .env podczas git push na githuba!
